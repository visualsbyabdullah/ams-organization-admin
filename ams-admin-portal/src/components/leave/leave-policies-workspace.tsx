...
export function LeavePoliciesWorkspace() {
  ...
  return (
    <div className="mx-auto max-w-360">
      <PageHeader
        eyebrow={
          LEAVE_POLICIES_COPY.eyebrow
        }
        title={
          LEAVE_POLICIES_COPY.title
        }
        description={
          LEAVE_POLICIES_COPY.description
        }
        actions={
          <Button
            onClick={() => {
      ...
      <Card className="mt-6">
        <div className="border-b border-border p-5">
          <h2 className="text-lg font-bold">
            {
              LEAVE_POLICIES_COPY.policiesTitle
            }
          </h2>
          ...
          <div className="mt-5 grid gap-3 lg:grid-cols-[minmax(0,1fr)_14rem_14rem]">
            <div className="relative">
              ...
              <Input
                ...
                placeholder={
                  LEAVE_POLICIES_COPY.searchPlaceholder
                }
                className="pl-9"
              />
            </div>
            ...
            >
              <option value="all">
                {
                  LEAVE_POLICIES_COPY.allStatuses
                }
              </option>
        ...
        {visiblePolicies.length > 0 ? (
          ...
          <div className="flex min-h-72 flex-col items-center justify-center p-8 text-center">
            ...
            <h3 className="mt-4 font-bold">
              {
                LEAVE_POLICIES_COPY.emptyTitle
              }
            </h3>
                ...
                {[
                  {
                    ...
                    enabled:
                      selectedPolicy.carryForwardEnabled,
                    detail:
                      selectedPolicy.carryForwardEnabled
                  ...
                  },
                  {
                    ...
                    enabled:
                      selectedPolicy.attachmentRequiredAfterDays >
                      0,
                    detail:
                      selectedPolicy.attachmentRequiredAfterDays >
                      0
