...
export function LeaveCalendarWorkspace() {
  ...
  function createRequest(
    ...
    setMonth(
      new Date(
        requestMonth.getFullYear(),
        requestMonth.getMonth(),
        1,
      ),
    );
  ...
  return (
    <div className="mx-auto max-w-360">
      <PageHeader
        eyebrow={
          LEAVE_CALENDAR_COPY.eyebrow
        }
        title={
          LEAVE_CALENDAR_COPY.title
        }
        description={
          LEAVE_CALENDAR_COPY.description
        }
        actions={
          <Button
            onClick={() =>
          ...
          <div className="border-b border-border p-5">
            <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
              <div>
                <h2 className="text-lg font-bold">
                  {
                    LEAVE_CALENDAR_COPY.calendarTitle
                  }
                </h2>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="min-w-38 text-center text-sm font-bold">
                  {monthLabel}
                </div>
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              ...
              >
                <option value="all">
                  {
                    LEAVE_CALENDAR_COPY.allLeaveTypes
                  }
                </option>
              ...
              >
                <option value="active">
                  {
                    LEAVE_CALENDAR_COPY.activeRequests
                  }
                </option>

                <option value="approved">
                  {
                    LEAVE_CALENDAR_COPY.approvedOnly
                  }
                </option>

                <option value="pending">
                  {
                    LEAVE_CALENDAR_COPY.pendingOnly
                  }
                </option>

                <option value="all">
                  {
                    LEAVE_CALENDAR_COPY.allStatuses
                  }
                </option>
              </Select>
            </div>
