...
export function LeaveRequestsWorkspace() {
  ...
  return (
    <div className="mx-auto max-w-360">
      <PageHeader
        eyebrow={
          LEAVE_REQUESTS_COPY.eyebrow
        }
        title={
          LEAVE_REQUESTS_COPY.title
        }
        description={
          LEAVE_REQUESTS_COPY.description
        }
        actions={
          <Button
            onClick={() =>
      ...
      <Card className="mt-6">
        <div className="border-b border-border p-5">
          <h2 className="text-lg font-bold">
            {
              LEAVE_REQUESTS_COPY.queueTitle
            }
          </h2>
          ...
          <div className="mt-5 grid gap-3 xl:grid-cols-[minmax(0,1fr)_13rem_14rem_14rem]">
            <div className="relative">
              ...
              <Input
                ...
                placeholder={
                  LEAVE_REQUESTS_COPY.searchPlaceholder
                }
                className="pl-9"
              />
            </div>
            ...
            >
              <option value="all">
                {
                  LEAVE_REQUESTS_COPY.allStatuses
                }
              </option>
            ...
            >
              {LEAVE_REQUEST_PERIOD_OPTIONS.map(
                (option) => (
                  <option
                    key={option.value}
                    value={option.value}
        ...
        {visibleRequests.length > 0 ? (
          ...
          <div className="flex min-h-72 flex-col items-center justify-center p-8 text-center">
            ...
            <h3 className="mt-4 font-bold">
              {
                LEAVE_REQUESTS_COPY.emptyTitle
              }
            </h3>
