...
import { getBranchCapacityUtilization, getBranchCoordinates } from "@/lib/branches";
...
export function createBranchColumns({
  ...
  return [
    ...
    },
    {
      id: "manager",
      header: "Manager",
      cell: (branch) => branch.managerName,
    },
    {
      id: "employees",
      header: "Employees",
      cell: (branch) => `${branch.employeeCount} / ${branch.capacity}`,
    },
    {
      id: "utilization",
      header: "Capacity",
      cell: (branch) => `${getBranchCapacityUtilization(branch)}%`,
    },
    {
      id: "coordinates",
      header: "Coordinates",
      cell: (branch) => (
        <span className="font-medium">{getBranchCoordinates(branch)}</span>
      ),
    },
    {
      id: "status",
