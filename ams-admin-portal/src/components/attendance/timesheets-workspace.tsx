...
export function TimesheetsWorkspace() {
  ...
  const chartData =
    useMemo<TimesheetChartPoint[]>(
      () =>
        DAY_LABELS.map(
          (day, index) => {
            const totals =
              visibleTimesheets.reduce(
                (
                  currentTotals,
                  timesheet,
                ) => {
                  ...
                  return {
                    regularMinutes:
                      currentTotals.regularMinutes +
                      (entry
                        ?.regularMinutes ??
                        0),

                    overtimeMinutes:
                      currentTotals.overtimeMinutes +
                      (entry
                        ?.overtimeMinutes ??
                        0),
                  };
  ...
  const statusChartData = [
    {
      name: "Approved",
      value: visibleTimesheets.filter(
        (timesheet) =>
          timesheet.status ===
          "approved",
      ).length,
      color:
        TIMESHEET_STATUS_CHART_COLORS.approved,
    },
    {
      name: "Pending",
      value: visibleTimesheets.filter(
      ...
      color:
        TIMESHEET_STATUS_CHART_COLORS.submitted,
    },
    {
      name: "Draft",
      value: visibleTimesheets.filter(
      ...
      color:
        TIMESHEET_STATUS_CHART_COLORS.draft,
    },
    {
      name: "Rejected",
      value: visibleTimesheets.filter(
      ...
      color:
        TIMESHEET_STATUS_CHART_COLORS.rejected,
    },
    {
      name: "Locked",
      value: visibleTimesheets.filter(
      ...
      color:
        TIMESHEET_STATUS_CHART_COLORS.locked,
    },
  ];
  ...
  return (
    <div className="mx-auto max-w-360">
      <PageHeader
        eyebrow={
          TIMESHEET_COPY.eyebrow
        }
        title={TIMESHEET_COPY.title}
        description={
          TIMESHEET_COPY.description
        }
        actions={
      ...
      <section className="mt-6 grid gap-6 xl:grid-cols-[1.35fr_0.65fr]">
        <ChartCard
          title={
            TIMESHEET_COPY.chartTitle
          }
          description={
            TIMESHEET_COPY.chartDescription
          }
        >
          <TimesheetHoursChart
            data={chartData}
        ...
        <ChartCard
          title={
            TIMESHEET_COPY.statusTitle
          }
          description={
            TIMESHEET_COPY.statusDescription
          }
        >
          <TimesheetStatusChart
          ...
          <div className="mt-5 grid gap-3 lg:grid-cols-[minmax(0,1fr)_14rem]">
            <div className="relative">
              ...
              <Input
                ...
                placeholder={
                  TIMESHEET_COPY.searchPlaceholder
                }
                className="pl-9"
              />
            </div>
        ...
        0 ? (
          ...
          <div className="flex min-h-72 flex-col items-center justify-center p-8 text-center">
            ...
            <h3 className="mt-4 font-bold">
              {
                TIMESHEET_COPY.noResults
              }
            </h3>

            <p className="mt-2 text-sm text-text-muted">
              Change the branch, period or
              status filters.
            </p>
          </div>
        )}
