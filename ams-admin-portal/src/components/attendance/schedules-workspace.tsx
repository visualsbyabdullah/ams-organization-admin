...
export function SchedulesWorkspace() {
  ...
  const metrics = [
    ...
    },
    {
      ...
      detail:
        "No shift in selected week",
      icon: UserMinus,
      tone: "warning" as const,
    },
    {
      label: "Schedule conflicts",
      value: scopedAssignments.filter(
        (assignment) =>
          assignment.status ===
          "conflict",
      ).length,
  ...
  return (
    <div className="mx-auto max-w-360">
      <PageHeader
        eyebrow={
          SCHEDULE_COPY.eyebrow
        }
        title={SCHEDULE_COPY.title}
        description={
          SCHEDULE_COPY.description
        }
        actions={
          <>
            <Button
            ...
            <div className="mt-5 grid gap-3 md:grid-cols-[minmax(0,1fr)_14rem]">
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder={
                    SCHEDULE_COPY.searchPlaceholder
                  }
                  className="pl-9"
                />
              </div>
              ...
              <section className="rounded-card border border-border">
                ...
                <dl className="grid gap-5 p-5 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <dd className="mt-1 text-sm font-semibold">
                      {
                        selectedAssignmentShift.breakMinutes
                      }{" "}
                      minutes
                    </dd>
                  </div>
                  ...
                  <div>
                    ...
                    <dd className="mt-1 text-sm font-semibold">
                      {formatMinutesAsHours(
                        selectedAssignmentShift.workingMinutes,
                      )}
                    </dd>
                  </div>
                </dl>
