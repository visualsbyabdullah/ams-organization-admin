...
export function AttendancePolicyForm({
  ...
  const [status, setStatus] =
    useState<AttendancePolicyStatus>(
      policy?.status ?? "draft",
    );

  const [scope, setScope] =
    useState<AttendancePolicyScope>(
    ...
    >
        ...
        >
          <Select
            ...
            onChange={(event) =>
              setStatus(
                event.target
                  .value as AttendancePolicyStatus,
              )
            }
          >
            <option value="active">
      ...
      <section>
        ...
        <p className="mt-1 text-sm text-text-muted">
          Choose whether this policy applies
          organization-wide or only to selected
          branches.
        </p>
          ...
          {[
            {
              ...
              label: "All branches",
              description:
                "Apply to the complete organization.",
            },
            {
              value:
        ...
        {scope ===
          ...
          <div className="mt-4">
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {ATTENDANCE_POLICY_BRANCH_OPTIONS.map(
                (branch) => {
                  const selected =
      ...
      <section>
        ...
        <p className="mt-1 text-sm text-text-muted">
          Configure working-hour and attendance
          exception limits.
        </p>
        ...
        <div className="mt-4 space-y-3">
          <div className="flex items-center justify-between gap-5 rounded-control border border-border p-4">
            <div>
              ...
              <p className="mt-1 text-xs text-text-muted">
                Validate employee location during
                mobile check-in.
              </p>
            </div>
          ...
          <div className="flex items-center justify-between gap-5 rounded-control border border-border p-4">
            <div>
              ...
              <p className="mt-1 text-xs text-text-muted">
                Permit approved employees to check
                in outside office locations.
              </p>
            </div>
          ...
          <div className="flex items-center justify-between gap-5 rounded-control border border-border p-4">
            <div>
              <p className="text-sm font-semibold">
                Automatically approve overtime
              </p>

              <p className="mt-1 text-xs text-text-muted">
                Skip manager approval for qualifying
                overtime records.
              </p>
            </div>
