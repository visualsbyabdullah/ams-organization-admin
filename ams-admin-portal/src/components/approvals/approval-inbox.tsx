...
import { APPROVAL_INBOX_ITEMS } from "@/config/approvals";

export function ApprovalInbox() {
  const totalPending = APPROVAL_INBOX_ITEMS.reduce(
    ...
    <div className="mx-auto max-w-360">
      ...
      <section className="mt-7 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <Card className="p-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-3 text-3xl font-bold tracking-tight">{totalPending}</p>

              <p className="mt-2 text-xs text-text-muted">Across operational modules</p>
            </div>
        ...
        <Card className="p-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-sm font-medium text-text-muted">Approval queues</p>
