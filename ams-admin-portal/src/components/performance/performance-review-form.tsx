...
import type { PerformanceReview, PerformanceReviewStatus } from "@/types/performance";
    ...
    <form onSubmit={handleSubmit} className="space-y-7">
      <div className="grid gap-5 sm:grid-cols-2">
        <FormField label="Review status" htmlFor="performanceReviewStatus">
          <Select
            id="performanceReviewStatus"
            value={status}
            onChange={(event) => setStatus(event.target.value as PerformanceReviewStatus)}
          >
        ...
        <FormField label="Competency score" htmlFor="performanceCompetencyScore">
          <Input
            id="performanceCompetencyScore"
            type="number"
            min="0"
            max="100"
            value={competencyScore}
            onChange={(event) => setCompetencyScore(event.target.value)}
          />
        </FormField>
      </div>
      ...
      <FormField label="Development areas" htmlFor="performanceDevelopmentAreas" optional>
        <Textarea
          id="performanceDevelopmentAreas"
