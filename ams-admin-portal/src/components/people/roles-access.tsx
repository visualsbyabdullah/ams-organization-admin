...
export function RolesAccess() {
  ...
  return (
    <div className="mx-auto max-w-360">
      <PageHeader
        eyebrow={
          ACCESS_CONTROL_COPY.eyebrow
        }
        title={
          ACCESS_CONTROL_COPY.title
        }
        description={
          ACCESS_CONTROL_COPY.description
        }
        actions={
          <Button
            onClick={() => {
          ...
          <div className="border-b border-border p-4">
            <div className="relative max-w-xl">
              ...
              <Input
                ...
                placeholder={
                  ACCESS_CONTROL_COPY.searchUsers
                }
                className="pl-9"
              />
            </div>
