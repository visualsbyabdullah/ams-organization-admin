...
export function LoanPoliciesWorkspace() {
  ...
  return (
    <div className="mx-auto max-w-360">
      <PageHeader
        eyebrow={
          LOAN_POLICIES_COPY.eyebrow
        }
        title={
          LOAN_POLICIES_COPY.title
        }
        description={
          LOAN_POLICIES_COPY.description
        }
        actions={
          <Button
            onClick={() => {
        ...
        <Card className="order-1 overflow-hidden">
          <div className="border-b border-border p-5">
            <h2 className="text-lg font-bold">
              {
                LOAN_POLICIES_COPY.registerTitle
              }
            </h2>
            ...
            <div className="mt-5 grid gap-3 xl:grid-cols-[minmax(0,1fr)_14rem_14rem]">
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder={
                    LOAN_POLICIES_COPY.searchPlaceholder
                  }
                  className="pl-9"
                />
              </div>
              ...
              >
                <option value="all">
                  {
                    LOAN_POLICIES_COPY.allStatuses
                  }
                </option>
        ...
        <Card className="order-2 h-fit p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold">
                {
                  LOAN_POLICIES_COPY.effectiveTitle
                }
              </h2>
          ...
          {effectivePolicy ? (
            <div className="mt-5 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="rounded-control bg-canvas p-4">
                  ...
                  <p className="mt-1 text-sm font-bold">
                    {
                      effectivePolicy.minimumServiceMonths
                    }{" "}
                    months
                  </p>
                </div>
                ...
                <div className="rounded-control bg-canvas p-4">
                  ...
                  <p className="mt-1 text-sm font-bold">
                    Up to{" "}
                    {
                      effectivePolicy.maximumInstallments
                    }
                  </p>
                </div>
                ...
                <div className="rounded-control bg-canvas p-4">
                  ...
                  <p className="mt-1 text-sm font-bold">
                    {
                      effectivePolicy.enabledLoanTypes
                        .length
                    }
                  </p>
                </div>
              ...
              <div className="space-y-2 pt-2">
                {effectivePolicy.enabledLoanTypes.map(
                  (type) => (
                    <div
                      key={type}
            ...
            <p className="mt-5 rounded-control bg-warning-muted p-4 text-sm font-medium text-warning">
              No active organization loan policy is
              available.
            </p>
          )}
        </Card>
          ...
          <div className="space-y-6">
            <section className="rounded-card border border-border">
              ...
              <dl className="grid gap-5 p-5 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm font-semibold">
                    {
                      selectedPolicy.minimumServiceMonths
                    }{" "}
                    months
                  </dd>
                </div>
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm font-semibold">
                    {
                      selectedPolicy.maximumSalaryMultiple
                    }
                    × monthly salary
                  </dd>
                </div>
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm font-semibold">
                    {formatPKR(
                      selectedPolicy.requireGuarantorAbove,
                    )}
                  </dd>
                </div>
              </dl>
            ...
            <section>
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {selectedPolicy.enabledLoanTypes.map(
                  (type) => (
                    <Badge
                      key={type}
                      variant={
                ...
                {[
                  {
                    ...
                    enabled:
                      selectedPolicy.automaticPayrollDeduction,
                  },
                  {
                    label:
                      "Emergency fast-track",
                    enabled:
                      selectedPolicy.emergencyFastTrack,
                  },
                  {
                    label:
                      "Concurrent loans",
                    enabled:
                      selectedPolicy.allowConcurrentLoans,
                  },
                  {
                    label:
                      "Finance review",
                    enabled:
                      selectedPolicy.financeReviewRequired,
                  },
                  {
                    label:
                      "Administrator approval",
                    enabled:
                      selectedPolicy.adminApprovalRequired,
                  },
                ].map((item) => (
                  <div
                    key={item.label}
            ...
            <section>
              ...
              <p className="mt-2 rounded-control bg-canvas p-4 text-sm leading-6 text-text-muted">
                {selectedPolicy.note ||
                  "No loan policy note has been added."}
              </p>
            </section>
          </div>
        )}
