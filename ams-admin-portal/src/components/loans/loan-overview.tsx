  ...
  return (
    <div className="mx-auto max-w-360">
      ...
      <section className="mt-6 grid gap-6 xl:grid-cols-[1.25fr_0.75fr]">
        <ChartCard
          title={
            LOANS_COPY.chartTitle
          }
          description={
            LOANS_COPY.chartDescription
          }
        >
          <LoanRepaymentChart
            data={trend}
          ...
          <div className="mt-5 space-y-3">
            {attentionLoans.length > 0 ? (
              ...
              <div className="rounded-control bg-success-muted p-4 text-sm font-medium text-success">
                No loan applications or repayments
      ...
      <Card className="mt-6">
        <div className="border-b border-border p-5">
          <h2 className="text-lg font-bold">
            {LOANS_COPY.tableTitle}
          </h2>

          <p className="mt-1 text-sm text-text-muted">
            {
              LOANS_COPY.tableDescription
            }
          </p>
        ...
        {visibleLoans.length > 0 ? (
          ...
          <div className="flex min-h-72 flex-col items-center justify-center p-8 text-center">
            ...
            <h3 className="mt-4 font-bold">
              {LOANS_COPY.emptyTitle}
            </h3>

            <p className="mt-2 text-sm text-text-muted">
              {
                LOANS_COPY.emptyDescription
              }
            </p>
          </div>
        )}
