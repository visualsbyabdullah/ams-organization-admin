...
export function PayrollOverview() {
  ...
  const [createRunOpen, setCreateRunOpen] =
    useState(false);
  ...
  return (
    <div className="mx-auto max-w-360">
      ...
      <section className="mt-6 grid gap-6 xl:grid-cols-[1.25fr_0.75fr]">
        <ChartCard
          title={
            PAYROLL_COPY.trendTitle
          }
          description={
            PAYROLL_COPY.trendDescription
          }
        >
          <PayrollTrendChart
            data={trend}
        ...
        <ChartCard
          title={
            PAYROLL_COPY.breakdownTitle
          }
          description={
            PAYROLL_COPY.breakdownDescription
          }
        >
          <PayrollCostBreakdownChart
            data={costBreakdown}
          />
        </ChartCard>
      </section>
        ...
        <Card className="overflow-hidden">
          <div className="border-b border-border p-5">
            <h2 className="text-lg font-bold">
              {PAYROLL_COPY.runsTitle}
            </h2>

            <p className="mt-1 text-sm text-text-muted">
              {
                PAYROLL_COPY.runsDescription
              }
            </p>
          </div>
          ...
          <div className="mt-5 grid gap-3 lg:grid-cols-[minmax(0,1fr)_14rem]">
            <div className="relative">
              ...
              <Input
                ...
                placeholder={
                  PAYROLL_COPY.searchPlaceholder
                }
                className="pl-9"
              />
            </div>
