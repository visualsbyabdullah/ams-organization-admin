...
export function PayrollAdjustmentForm({
  ...
  const [type, setType] =
    useState<PayrollAdjustmentType>(
  ...
  const [
    ...
    useState<PayrollAdjustmentFrequency>(
  ...
  return (
    ...
    >
      <section className="grid gap-5 md:grid-cols-2">
        ...
        <FormField
          label="Effective payroll period"
          htmlFor="adjustmentPeriod"
        >
          <Input
            id="adjustmentPeriod"
            type="month"
        ...
        >
          <Select
            ...
            onChange={(event) =>
              setFrequency(
                event.target
                  .value as PayrollAdjustmentFrequency,
              )
            }
          >
            {Object.entries(
      ...
      <div className="flex items-center justify-between gap-5 rounded-control border border-border p-4">
        <div>
          ...
          <p className="mt-1 text-xs text-text-muted">
            Include this amount in taxable employee
            earnings.
          </p>
        </div>
      ...
      <FormField
        label="Internal note"
        htmlFor="adjustmentInternalNote"
        optional
      >
        <Textarea
