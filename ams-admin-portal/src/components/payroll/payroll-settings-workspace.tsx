        ...
        <Card>
          <div className="border-b border-border p-5">
            ...
            <SearchFilterBar
              ...
              searchPlaceholder={PAYROLL_SETTINGS_COPY.searchPlaceholder}
              ...
              filters={[
                {
                  ...
                  children: (
                    <>
                      ...
                      {Object.entries(PAYROLL_SETTINGS_SCOPE_CONFIG).map(
                        ([value, config]) => (
                ...
                },
                {
                  ...
                  children: (
                    <>
                      ...
                      {Object.entries(PAYROLL_SETTINGS_STATUS_CONFIG).map(
                        ([value, config]) => (
                          <option key={value} value={value}>
                            {config.label}
                          </option>
