...
function getPayDateLabel(
  ...
  return PAYROLL_PAY_DATE_RULE_CONFIG[
    configuration.payDateRule
  ].label;
}
...
export function PayrollSettingsWorkspace() {
  ...
  function saveConfiguration(
    nextConfiguration: PayrollSettingsRecord,
  ) {
    setConfigurations(
      (currentConfigurations) => {
        const exists =
          currentConfigurations.some(
            (configuration) =>
              configuration.id ===
  ...
  return (
    <div className="mx-auto max-w-360">
      <PageHeader
        eyebrow={
          PAYROLL_SETTINGS_COPY.eyebrow
        }
        title={
          PAYROLL_SETTINGS_COPY.title
        }
        description={
          PAYROLL_SETTINGS_COPY.description
        }
        actions={
          <Button
            onClick={() => {
        ...
        <Card>
          <div className="border-b border-border p-5">
            <h2 className="text-lg font-bold">
              {
                PAYROLL_SETTINGS_COPY.settingsTitle
              }
            </h2>
            ...
            <div className="mt-5 grid gap-3 lg:grid-cols-[minmax(0,1fr)_14rem_14rem]">
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder={
                    PAYROLL_SETTINGS_COPY.searchPlaceholder
                  }
                  className="pl-9"
                />
              </div>
              ...
              >
                <option value="all">
                  {
                    PAYROLL_SETTINGS_COPY.allScopes
                  }
                </option>
              ...
              >
                <option value="all">
                  {
                    PAYROLL_SETTINGS_COPY.allStatuses
                  }
                </option>
          ...
          0 ? (
            ...
            <div className="flex min-h-72 flex-col items-center justify-center p-8 text-center">
              ...
              <h3 className="mt-4 font-bold">
                {
                  PAYROLL_SETTINGS_COPY.emptyTitle
                }
              </h3>
        ...
        <Card className="h-fit p-5">
          ...
          {effectiveConfiguration ? (
              ...
              {[
                {
                  ...
                  value:
                    PAYROLL_SCHEDULE_CONFIG[
                      effectiveConfiguration.schedule
                    ].label,
                  icon: CalendarClock,
                },
                {
            ...
            <p className="mt-5 rounded-control bg-warning-muted p-4 text-sm font-medium text-warning">
              No active organization payroll
              ...
              <div className="flex items-start justify-between gap-4 border-b border-border p-5">
                <div>
                  ...
                  <p className="mt-1 text-xs text-text-muted">
                    Updated by{" "}
                    {
                      selectedConfiguration.updatedBy
                    }{" "}
                    on{" "}
                    {formatDate(
              ...
              <dl className="grid gap-5 p-5 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm font-semibold">
                    {
                      PAYROLL_SCHEDULE_CONFIG[
                        selectedConfiguration.schedule
                      ].label
                    }
                  </dd>
                </div>
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm font-semibold">
                    Day{" "}
                    {
                      selectedConfiguration.cutoffDay
                    }
                  </dd>
                </div>
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm font-semibold">
                    {
                      selectedConfiguration.standardWorkingDays
                    }{" "}
                    days
                  </dd>
                </div>
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm font-semibold">
                    {
                      selectedConfiguration.standardDailyHours
                    }{" "}
                    hours
                  </dd>
                </div>
                ...
                {[
                  {
                    label:
                      "Finance approval",
                    enabled:
                      selectedConfiguration.requireFinanceApproval,
                  },
                  {
                    label:
                      "Administrator approval",
                    enabled:
                      selectedConfiguration.requireAdminApproval,
                  },
                  {
                    label:
                      "Lock approved runs",
                    enabled:
                      selectedConfiguration.autoLockApprovedRuns,
                  },
                ].map((item) => (
                  <div
                    key={item.label}
                ...
                {[
                  {
                    label:
                      "Attendance overtime",
                    enabled:
                      selectedConfiguration.includeAttendanceOvertime,
                  },
                  {
                    label:
                      "Unpaid leave deductions",
                    enabled:
                      selectedConfiguration.deductUnpaidLeave,
                  },
                  {
                    label:
                      "Automatic payslips",
                    enabled:
                      selectedConfiguration.autoGeneratePayslips,
                  },
                  {
                    label:
                      "Email payslips",
                    enabled:
                      selectedConfiguration.emailPayslips,
                  },
                ].map((item) => (
                  <div
                    key={item.label}
              ...
              <dl className="mt-3 grid gap-3 sm:grid-cols-2">
                <div className="rounded-control bg-canvas p-4">
                  ...
                  <dd className="mt-1 text-sm font-semibold">
                    {
                      PAYROLL_ROUNDING_MODE_CONFIG[
                        selectedConfiguration.roundingMode
                      ].label
                    }
                  </dd>
                </div>
