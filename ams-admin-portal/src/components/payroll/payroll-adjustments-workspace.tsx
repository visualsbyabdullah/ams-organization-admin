...
export function PayrollAdjustmentsWorkspace() {
  ...
  const visibleAdjustments =
    useMemo(() => {
      const query = searchQuery
        .trim()
        .toLowerCase();

      return scopedAdjustments.filter(
        (adjustment) => {
          const employee =
            EMPLOYEES.find(
              (item) =>
  ...
  const selectedEmployee =
    selectedAdjustment
      ? EMPLOYEES.find(
          (employee) =>
            employee.id ===
            selectedAdjustment.employeeId,
        )
      : null;

  const currentPeriodAdjustments =
    scopedAdjustments.filter(
      (adjustment) =>
        adjustment.effectivePeriod ===
        "2026-07",
    );
  ...
  const metrics = [
    ...
    },
    {
      ...
      value: scopedAdjustments.filter(
        (adjustment) =>
          adjustment.status ===
          "applied",
      ).length,
  ...
  function saveAdjustment(
    nextAdjustment: PayrollAdjustment,
  ) {
    setAdjustments(
      (currentAdjustments) => {
        const exists =
          currentAdjustments.some(
            (adjustment) =>
              adjustment.id ===
              nextAdjustment.id,
          );
    ...
    const duplicate: PayrollAdjustment =
      {
        ...
        internalNote:
          `Created from ${PAYROLL_ADJUSTMENT_TYPE_CONFIG[adjustment.type].label} adjustment.`,
      };
  ...
  return (
    <div className="mx-auto max-w-360">
      <PageHeader
        eyebrow={
          PAYROLL_ADJUSTMENTS_COPY.eyebrow
        }
        title={
          PAYROLL_ADJUSTMENTS_COPY.title
        }
        description={
          PAYROLL_ADJUSTMENTS_COPY.description
        }
        actions={
          <>
      ...
      <section className="mt-6 grid gap-6 xl:grid-cols-[minmax(0,1fr)_22rem]">
        <Card className="overflow-hidden">
          <div className="border-b border-border p-5">
            <h2 className="text-lg font-bold">
              {
                PAYROLL_ADJUSTMENTS_COPY.tableTitle
              }
            </h2>
            ...
            <div className="mt-5 grid gap-3 xl:grid-cols-[minmax(0,1fr)_13rem_13rem]">
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder={
                    PAYROLL_ADJUSTMENTS_COPY.searchPlaceholder
                  }
                  className="pl-9"
                />
              </div>
              ...
              >
                <option value="all">
                  {
                    PAYROLL_ADJUSTMENTS_COPY.allTypes
                  }
                </option>
              ...
              >
                <option value="all">
                  {
                    PAYROLL_ADJUSTMENTS_COPY.allStatuses
                  }
                </option>
            ...
            <div className="mt-3 grid gap-3 sm:grid-cols-2">
              ...
              >
                <option value="all">
                  {
                    PAYROLL_ADJUSTMENTS_COPY.allDirections
                  }
                </option>
              ...
              >
                {PAYROLL_ADJUSTMENT_PERIOD_OPTIONS.map(
                  (option) => (
                    <option
                      key={option.value}
                      value={option.value}
          ...
          0 ? (
            ...
            <div className="flex min-h-72 flex-col items-center justify-center p-8 text-center">
              ...
              <h3 className="mt-4 font-bold">
                {
                  PAYROLL_ADJUSTMENTS_COPY.emptyTitle
                }
              </h3>
        ...
        <Card className="h-fit p-5">
          <h2 className="text-lg font-bold">
            {
              PAYROLL_ADJUSTMENTS_COPY.attentionTitle
            }
          </h2>
          ...
          <div className="mt-5 space-y-3">
            ...
            0 ? (
              ...
              <div className="rounded-control bg-success-muted p-4 text-sm font-medium text-success">
                No payroll adjustments are waiting
                for approval.
              </div>
            )}
          </div>
          ...
          selectedEmployee && (
            <div className="space-y-6">
                ...
                <dl className="grid gap-5 p-5 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <dd className="mt-1 text-sm font-semibold">
                      {formatPeriod(
                        selectedAdjustment.effectivePeriod,
                      )}
                    </dd>
                  </div>
              ...
              <section>
                ...
                <p className="mt-2 rounded-control bg-canvas p-4 text-sm leading-6 text-text-muted">
                  {selectedAdjustment.internalNote ||
