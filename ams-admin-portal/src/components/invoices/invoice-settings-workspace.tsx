        ...
        <Card className="order-1 overflow-hidden">
          <div className="border-b border-border p-5">
            ...
            <SearchFilterBar
              ...
              searchPlaceholder={INVOICE_COPY.settings.searchPlaceholder}
              ...
              filters={[
                {
                  ...
                  children: (
                    <>
                      ...
                      {Object.entries(INVOICE_SETTINGS_SCOPE_CONFIG).map(
                        ([value, config]) => (
                ...
                },
                {
                  ...
                  children: (
                    <>
                      ...
                      {Object.entries(INVOICE_SETTINGS_STATUS_CONFIG).map(
                        ([value, config]) => (
                          <option key={value} value={value}>
                            {config.label}
                          </option>
