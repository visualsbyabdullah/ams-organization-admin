...
export const SETTINGS_FIELD_CONFIG: Record<
  SettingsCategory,
  SettingsFieldDefinition[]
> = {
  organization: [
...
export const SETTINGS_COPY = {
  ...
  create: "Create",
  searchPlaceholder:
    "Search profile, branch, provider or actor",
  emptyTitle: "No settings records found",
  emptyDescription:
    "Change the filters or add a new settings record.",
};
...
> = {
  overview: {
    ...
    description:
      "Review effective platform settings and recent administrative activity.",
  },
  organization: {
    title: "Organization settings",
    description:
      "Configure identity, date, workweek and branch override defaults.",
  },
  security: {
    title: "Security settings",
    description:
      "Manage sessions, passwords, MFA, approvals and audit retention.",
  },
  notifications: {
    title: "Notification settings",
    description:
      "Configure channels, digests and operational event alerts.",
  },
  integrations: {
    title: "Integrations",
    description:
      "Manage email, attendance, payroll, storage and calendar connections.",
  },
  audit: {
    title: "Settings audit log",
    description:
      "Review immutable administrative settings activity.",
  },
};
