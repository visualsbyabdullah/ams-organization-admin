import type { CompensationHistory, CompensationRecord } from "@/types/compensation";
...
export const COMPENSATION_RECORDS: CompensationRecord[] = [
  {
    ...
    lastChangeReason: "annual_review",
    previousBaseSalary: 165000,
    updatedAt: "2026-01-02",
    updatedBy: "Maaz",
    note: "Annual compensation adjustment approved for 2026.",
  },
  {
    id: "compensation-002",
    employeeId: "emp-002",
    ...
    lastChangeReason: "market_adjustment",
    previousBaseSalary: 110000,
    updatedAt: "2026-07-10",
    updatedBy: "Ayesha Khan",
    note: "Market adjustment review is pending final approval.",
  },
  {
    id: "compensation-003",
    employeeId: "emp-003",
    ...
    updatedBy: "Maaz",
    note: "Updated following promotion to senior payroll specialist.",
  },
  {
    id: "compensation-004",
    employeeId: "emp-004",
  ...
  },
  {
    ...
    lastChangeReason: "role_change",
    previousBaseSalary: 90000,
    updatedAt: "2026-07-12",
    updatedBy: "Ayesha Khan",
    note: "Role scope changed; compensation review required.",
  },
  {
    id: "compensation-006",
    employeeId: "emp-006",
    ...
    updatedBy: "Maaz",
    note: "Initial employee compensation package.",
  },
];
...
export const COMPENSATION_HISTORY: CompensationHistory[] = [
  ...
  },
  {
    ...
    compensationId: "compensation-002",
    employeeId: "emp-002",
    previousBaseSalary: 110000,
    ...
    note: "Market alignment adjustment.",
  },
  {
    id: "compensation-history-003",
    compensationId: "compensation-003",
    employeeId: "emp-003",
    previousBaseSalary: 140000,
    ...
    reason: "promotion",
    approvedBy: "Maaz",
    note: "Promotion compensation change.",
  },
  {
    id: "compensation-history-004",
    compensationId: "compensation-004",
    employeeId: "emp-004",
    previousBaseSalary: 132000,
