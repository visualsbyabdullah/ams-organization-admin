...
export const LEAVE_REQUESTS: LeaveRequest[] = [
  ...
  },
  {
    ...
    managerNote: "Coverage arranged with the payroll team.",
  },
  {
    id: "leave-003",
    employeeId: "emp-006",
  ...
  },
  {
    ...
    endDate: "2026-07-23",
    totalDays: 5,
    reason: "Travel outside the city.",
    status: "approved",
    requestedAt: "2026-07-10",
    reviewedBy: "Ayesha Khan",
    reviewedAt: "2026-07-11",
    managerNote: "Approved after confirming team coverage.",
  },
  {
    id: "leave-005",
    employeeId: "emp-004",
  ...
  },
  {
    ...
    reviewedBy: "Ayesha Khan",
    reviewedAt: "2026-07-11",
    managerNote: "Request was submitted after the correction window.",
  },
  {
    id: "leave-008",
    employeeId: "emp-004",
    ...
    endDate: "2026-08-12",
    totalDays: 3,
    reason: "Extended personal commitment.",
    status: "cancelled",
...
export const LEAVE_TRENDS: Record<string, LeaveTrendPoint[]> = {
  all: [
    {
      month: "Jan",
      approved: 18,
